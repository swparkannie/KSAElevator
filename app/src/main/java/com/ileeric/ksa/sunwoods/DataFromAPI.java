...
public class DataFromAPI {
    ...
    /*
    public void GetChangjo() {
        try {
            RestAPITask apiTask = new RestAPITask("changjo");
            apiTask.execute();
            ...
            C_data.add(Integer.parseInt(inElevator.getString("C1")));
            C_data.add(Integer.parseInt(inElevator.getString("C2")));
            C_data.add(Integer.parseInt(inElevator.getString("C3")));
            C_data.add(Integer.parseInt(inElevator.getString("C4")));
            C_data.add(Integer.parseInt(inElevator.getString("C5")));
            C_data.add(Integer.parseInt(inElevator.getString("C6")));
            C_data.add(Integer.parseInt(inElevator.getString("C7")));
            C_data.add(Integer.parseInt(inElevator.getString("C8")));
    ...
    Thread GetTamguThread = new Thread() {
        public void run()
        {
            try {
                ...
                T_data.add(Integer.parseInt(inElevator.getString("T1")));
                T_data.add(Integer.parseInt(inElevator.getString("T2")));
                T_data.add(Integer.parseInt(inElevator.getString("T3")));
                T_data.add(Integer.parseInt(inElevator.getString("T4")));
                T_data.add(Integer.parseInt(inElevator.getString("T5")));
                T_data.add(Integer.parseInt(inElevator.getString("T6")));
